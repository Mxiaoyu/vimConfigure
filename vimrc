...
"如果文件类型为.sh文件
    if &filetype == 'sh'
        ...
        call append(line(".")+6, "\# Author: majianwei<majianwei01@baidu.com>")
    ...
    if &filetype == 'python'
        ...
        call append(line(".")+8, " Author: majianwei<majianwei01@baidu.com>")
    ...
    if &filetype == 'c'
        ...
        call append(line(".")+1, "* Author: majianwei<majianwei01@baidu.com>")
